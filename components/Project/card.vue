...
<template>
  <div
    class="max-w-4xl bg-white bg-opacity-50 dark:bg-opacity-0 dark:backdrop-blur-0 backdrop-blur-xl mx-auto p-7 rounded-3xl flex flex-col md:flex-row"
  >
    <figure
      class="max-w-xl max-h-80 h-full w-full md:w-8/12 rounded-2xl overflow-hidden"
    >
      <img
