...
<template>
  ...
  >
    ...
    >
      <h1 class="text-2xl md:text-3xl font-bold mb-5 bg-gray-300 animate-pulse h-6  w-1/2"></h1>
      <p v-for="x in 4" class="text-sm bg-gray-300 animate-pulse h-4 content[''] mb-2"></p>
      <div class="my-3 mt-5">
        <h1 class="font-bold mb-1 bg-gray-300 animate-pulse h-4 w-1/3"></h1>
        <div
          class="flex space-x-2 pb-1 text-2xl text-gray-600 dark:text-gray-300"
        >
        </div>
      </div>
      <button class="h-7 w-14 bg-gray-300 animate-pulse"></button>
    </div>
  </div>
</template>
